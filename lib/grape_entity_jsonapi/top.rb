module GrapeEntityJsonapi
  class Top < Grape::Entity
    expose :data,
      ...
      unless: lambda { |intance, options| instance.errors.present? }

    expose :errors,
      using: ::GrapeEntityJsonapi::Errors,
      if: lambda { |intance, options| instance.errors.present? }

    # meta may display any hash
    expose :meta, if: lambda { |instance, options| instance.meta.present? }
